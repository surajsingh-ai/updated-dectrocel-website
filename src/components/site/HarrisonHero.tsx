  ...
  return (
    <section className="bg-white px-4 pb-14 pt-24 sm:px-6 md:pb-16 md:pt-32 lg:px-8">
      <div className="mx-auto max-w-[1240px]">
        ...
        <div className={`mx-auto max-w-[900px] text-center ${image ? "mt-10 md:mt-14" : ""}`}>
          ...
          {cta && !image && (
            <Link
              to="/contact"
              className="mt-8 inline-flex max-w-full items-center justify-center gap-3 bg-[#061a63] px-5 py-3 text-base font-extrabold text-white transition-colors hover:bg-[#177fed] md:text-lg"
            >
              {cta}
              <span className="grid size-8 place-items-center bg-[#177fed] text-white">
                <ArrowUpRight className="size-5" />
